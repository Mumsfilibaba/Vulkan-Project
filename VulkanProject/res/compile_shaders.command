...
/usr/local/bin/glslc -fshader-stage=vertex   -O shaders/aabb_debug_vs.glsl -o shaders/aabb_debug_vs.spv
/usr/local/bin/glslc -fshader-stage=fragment -O shaders/aabb_debug_fs.glsl -o shaders/aabb_debug_fs.spv
